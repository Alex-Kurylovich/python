...
def patch_resource(resource, pre=None, post=None):
    ...
    operation.  The only argument to these functions is the resource instance.
    It's very generic but also very flexible way to monitor all aspects of all kinds of resources.
    """
